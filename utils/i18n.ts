...
export const translations = {
  en: {
    ...
    maxReservationsDescription: 'Maximum number of reservations allowed for each time slot',
    ...
    helpSupportDescription: 'Get help and support for your restaurant management',
    ...
    howToAcceptReservationAnswer: 'Tap on any reservation from the list to view details, then use the Accept or Decline buttons at the bottom.',
    howToManageTables: 'How do I manage my table settings?',
    howToManageTablesAnswer: 'Go to Settings > Table Settings to configure your reservation preferences, business hours, and table capacity.',
    howToChangeLanguage: 'How do I change the app language?',
    howToChangeLanguageAnswer: 'Go to Profile settings and select your preferred language from the Language dropdown menu.',
    howToSetBusinessHours: 'How do I set my business hours?',
    howToSetBusinessHoursAnswer: 'In Table Settings, you can set your opening and closing times, and configure available time slots for reservations.',
    ...
    supportHoursDetails: 'Monday - Friday: 9:00 AM - 6:00 PM (EST)\nWeekend: 10:00 AM - 4:00 PM (EST)',
  ...
  fr: {
    ...
    noNotificationsDescription: 'Vous n\'avez aucune nouvelle notification pour le moment.',
    ...
    allowCustomersBookOnline: 'Permettre aux clients de réserver des tables en ligne',
    ...
    maxReservationsDescription: 'Nombre maximum de réservations autorisées pour chaque créneau horaire',
    ...
    helpSupportDescription: 'Obtenez de l\'aide et du support pour la gestion de votre restaurant',
    ...
    howToAcceptReservationAnswer: 'Appuyez sur n\'importe quelle réservation de la liste pour voir les détails, puis utilisez les boutons Accepter ou Refuser en bas.',
    howToManageTables: 'Comment gérer les paramètres de mes tables ?',
    howToManageTablesAnswer: 'Allez dans Paramètres > Paramètres des Tables pour configurer vos préférences de réservation, heures d\'ouverture et capacité des tables.',
    howToChangeLanguage: 'Comment changer la langue de l\'application ?',
    howToChangeLanguageAnswer: 'Allez dans les paramètres de Profil et sélectionnez votre langue préférée dans le menu déroulant Langue.',
    howToSetBusinessHours: 'Comment définir mes heures d\'ouverture ?',
    howToSetBusinessHoursAnswer: 'Dans les Paramètres des Tables, vous pouvez définir vos heures d\'ouverture et de fermeture, et configurer les créneaux horaires disponibles pour les réservations.',
    ...
    supportHoursDetails: 'Lundi - Vendredi : 9h00 - 18h00 (EST)\nWeek-end : 10h00 - 16h00 (EST)',
