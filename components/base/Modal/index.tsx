...
export const Modal: React.FC<ModalProps> = ({
  ...
  const defaultCancelText = cancelText || t("modelCancel");
  const defaultSureText = sureText || t("modelOk");
  ...
  const renderButtons = () => {
    ...
    const singleButtonText = hasOk ? defaultSureText : defaultCancelText;
